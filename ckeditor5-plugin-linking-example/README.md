@authorium/ckeditor5-plugin-linking-example
===========================================
...
The `@authorium/ckeditor5-plugin-linking-example` package is available under [MIT license](https://opensource.org/licenses/MIT).
